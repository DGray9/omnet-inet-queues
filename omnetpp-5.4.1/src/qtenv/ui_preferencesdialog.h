...
"  - %> function call depth times 2-space indentation (see Enter_M"
        ...
        scrollbackText->setText(QApplication::translate("PreferencesDialog", "Scrollback buffer (lines):", Q_NULLPTR));
        applies->setText(QApplication::translate("PreferencesDialog", "Applies to main window and module log windows. Leave blank for unlimited. Minimum value is 500 lines.", Q_NULLPTR));
